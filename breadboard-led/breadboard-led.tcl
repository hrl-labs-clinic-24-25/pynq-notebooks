...
\
  ...
  set_property CONFIG.M00_HAS_DATA_FIFO {0} $axi_interconnect_0
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_interconnect_0/S00_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_ports led]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"1107,-72",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace portBus led -pg 1 -lvl 4 -x 1550 -y 160 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 320 -y 80 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 890 -y 160 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1390 -y 150 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 320 -y 280 -defaultsOSRD
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 740 20 1040
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 10 -20 730 10 1060
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 20 -10 620
preplace netloc axi_gpio_0_gpio_io_o 1 3 1 N 160
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 1050 130n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 1 1 630 50n
levelinfo -pg 1 -10 320 890 1390 1550
pagesize -pg 1 -db -bbox -sgen -120 -30 2390 1280
"
}
