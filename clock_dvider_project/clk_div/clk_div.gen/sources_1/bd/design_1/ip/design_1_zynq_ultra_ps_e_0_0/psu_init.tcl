...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700E0 0xFFFFFFFF 0x00100200
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x0608070C
    ...
    mask_write 0XFD070124 0x40070F3F 0x00020309
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x048B8208
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00310F08
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000B0F
    ...
    mask_write 0XFD080188 0xFFFFFFFF 0x00000010
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x00040000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x00008046 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
